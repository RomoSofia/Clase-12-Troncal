...
const colorNaranjo = "rgba(232, 87, 26, 0.82)";
const colorAzul = "rgba(37, 67, 116, 0.82)";
const colorGris = "rgba(102, 102, 102, 0.55)";
...
new Chart(document.getElementById("vacantesTipoInstitucion"), {
    ...
    data: {
        ...
        datasets: [
            {
                data: [2717, 4699, 170],
                backgroundColor: [colorAzul, colorNaranjo, colorGris],
                borderColor: "#fff",
                borderWidth: 2,
                hoverOffset: 8,
            },
            ...
            tooltip: {
                ...
                callbacks: {
                    label: function (context) {
                        ...
                        return context.label + ": " + (valor) + " vacantes (" + porcentaje + "%)";
                    },
                },
            },
        },
